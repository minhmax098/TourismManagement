...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Trang cá nhân<i class="fa fa-angle-right"></i> Thay đổi mật khẩu</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
	...
	<div class="form-group">
				...
				<button type="submit" name="submit" class="btn-primary btn">Gửi đi</button>
