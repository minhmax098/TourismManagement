...
$msg="Booking Cancelled sucessfully";
}
else
{
...
<?php if($result->status==2)
{
	?><td>Cancelled</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn thực sự có muốn hủy đặt Tour')" >Hủy</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
